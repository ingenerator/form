...
abstract class BaseFieldTestCase extends BaseFormElementTestCase
{
    ...
    #[TestWith([['label' => 'Name', 'display_label' => 'Candidate name'], 'Candidate name'])]
    ...
    #[TestWith([[], []])]
    #[TestWith([['field' => ['first error']], ['first error']])]
    #[TestWith([['field' => ['first error', 'other error']], ['first error', 'other error']])]
    #[TestWith([['field' => 'just the one error'], ['just the one error']])]
    ...
    #[TestWith([[], null])]
    #[TestWith([['empty_value' => "You didn't do this"], "You didn't do this"])]
    ...
    protected function newSubject(array $values = []): AbstractFormField
    {
